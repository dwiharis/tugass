            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="./tpetugas.php">
		    ...
		    if(mysqli_num_rows($sql) > 0){
		      ...
		      while($tampil = mysqli_fetch_array($qbayar)){
		        ...
		        if( $_SESSION['level'] == 1 ){
		         ...
		         echo ' <a href="./cetak.php?submit=nota&id_pembayaran='.$id_bayar.'" target="_blank" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-print" aria-hidden="true">Cetak</span></a>';
		         echo '</td></tr>';
				} 

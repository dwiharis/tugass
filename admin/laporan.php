...
<div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <a href="cetak_laporan.php?submit=cetak&tgl1=<?php echo $tanggal1; ?>&tgl2=<?php echo $tanggal2; ?>" class="btn btn-warning col-2" role="button" target="output">Cetak</a> &nbsp&nbsp&nbsp&nbsp <label><?php echo "Mulai ". date('d F Y', strtotime($tgl1)) ." Hingga ".date('d F Y', strtotime($tgl2));  ?></label><br><br>
...
<form class="form-inline" role="form" method="post" action="">
    ...
    <label class="" for="tgl1">Mulai</label>
                            <div class="col-sm-9">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                             <label class="" for="tgl2">Hingga</label>
                            <div class="col-sm-9">  
...
<?php 
   ...
   $tgl = date("d/m/Y");?>
         ...
         <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <a href="cetak_laporan.php" class="btn btn-warning col-2" role="button" target="output">Cetak</a> 
                    <br><br>
